  ...
  , DCOPObject("interface")
{
    ...
    connect(urlRequester->lineEdit(),SIGNAL(textChanged ( const QString & )),this,SLOT(slotTextChanged(const QString & )));
...
void KSnapshot::slotTextChanged(const QString &_text )
{
  PushButton3->setEnabled(!_text.isEmpty());
}
